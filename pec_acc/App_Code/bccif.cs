...
public class bccif
{
    ...
    static string oradb = "Data Source=(DESCRIPTION=(ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.5.25)(PORT = 1521))(CONNECT_DATA=(SERVICE_NAME = P01)));User ID=pbhle_d;Password=pbhle_d";
